...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            ...
            return redirect()->route('book.index')->with('Book Added Successfully!');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $book->update($data);
        return redirect()->route('book.index')->with('Book Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('book.index')->with('Book Deleted Successfully!');
    }
}
