						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-3">
										@if ($book_discount) <span style="font-size: 12px; text-decoration :line-through; color:red">@currency($book_price)</span> @endif
										@currency(($book_discount) ? $book_discount : $book_price)
									</td>
									<td class="column-4">
									...
									@php ($total = (($book_discount) ? $book_discount : $book_price) * $cart->qty)
									@php ($totals += $total)
			...
			<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
					...
					<div class="p-t-10 text-center">
						<a href="{{ route('user.address') }}" class="btn btn-success">Setting Address</a>
					</div>
					@endif
				</div>
			</div>
